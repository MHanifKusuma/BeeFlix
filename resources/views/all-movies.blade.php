...
<html lang="en">
    ...
    <div class="container-fluid" style="margin-top: 30px; margin-bottom: 20px">
        ...
        <div class="container-fluid" style="margin-bottom: 20px">
            <div class="row">
                <h3 class="text-light text-center" style="padding-left: 10px">Movies List</h3>
            </div>
            <div class="row">
                @foreach($movies as $m)
                <div class="col-md-auto" style="margin-bottom: 30px">
                    <div class="card" style="heigth: 435px; width: 215px;">
                        <img src="{{ $m->photo }}" class="card-img-top" style="width: 215px; " alt="movie_image">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title" style="height: 50px">{{$m->title}}</h5>
                            <p class="card-text text-primary" >{{$m->genre->name}}</p>
                            <a class="btn btn-info" style="margin-top:auto" href="/movies/{{$m->id}}">See detail</a>
                        </div>
                    </div>
                </div>
                @endforeach
